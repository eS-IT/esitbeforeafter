 ...
 */
$GLOBALS['TL_CTE']['media']['beforeafter'] = '\\esit\\esitbeforeafter\\classes\\contao\\elements\\BeforeAfter';
 ...
 * BEFOREAFTER
 */
$GLOBALS['esit']['beforeafter']['defaults'] = array(

    'introDelay'        => '1000',
    'introDuration'     => '1000',
    'beforeLinkText'    => 'Nur das erste Bild anzeigen',
    'afterLinkText'     => 'Nur das zweite Bild anzeigen',
    'cursor'            => 'pointer',
    'clickSpeed'        => '600',
    'linkDisplaySpeed'  => '200',
    'dividerColor'      => '#888',
    'keypressAmount'    => '20',
    'imagePath'         => 'system/modules/esitbeforeafter/assets/js/beforeafter/js/',
    'introPosition'     => '50',    // muss für JS .5 werden (oder .50)
    'animateIntro'      => '',      // muss für JS 'true' oder 'false' sein
    'showFullLinks'     => '',      // muss für JS 'true' oder 'false' sein
    'enableKeyboard'    => '',      // muss für JS 'true' oder 'false' sein
);

$GLOBALS['esit']['beforeafter']['groups'] = array(
    'babeforelinktext'  => 'bashowfulllinks',
    'baafterlinktext'   => 'bashowfulllinks',
    'baintrodelay'      => 'baanimateintro',
    'baintroduration'   => 'baanimateintro',
    'baintroposition'   => 'baanimateintro'
);